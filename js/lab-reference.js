  ...
  "fileStatus": [
        ...
        "causes": [
          {
            ...
            "desc": "O comando de I/O (OPEN, READ, WRITE, CLOSE) foi executado sem erros."
          }
        ],
        "resolution": [
          "Prossiga com o fluxo normal do programa."
        ],
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "KSDS com DUPLICATES",
            "desc": "Um READ ou WRITE encontrou registro com chave alternada duplicada em um arquivo definido com ALTERNATE KEY WITH DUPLICATES."
          },
          {
            "title": "READ genérico",
            "desc": "O registro lido possui chave alternada que existe em mais de um registro."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Tamanho variável",
            "desc": "O registro lido tem comprimento diferente do definido na FD do programa COBOL."
          },
          {
            "title": "Definição inconsistente",
            "desc": "O RECORDSIZE no DEFINE CLUSTER não corresponde ao RECORD CONTAINS da FD."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O arquivo foi declarado como SELECT OPTIONAL e não existe fisicamente no momento do OPEN INPUT."
          },
          {
            "title": "Dataset não catalogado",
            "desc": "O DD aponta para um dataset que não existe ou não está catalogado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "CLOSE inadequado",
            "desc": "O programa executou CLOSE REEL/UNIT em um arquivo que não está em dispositivo de fita multi-reel."
          },
          {
            "title": "Dispositivo DASD",
            "desc": "Tentou-se CLOSE com opções de fita em um dataset alocado em disco."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Fim dos registros",
            "desc": "Um READ ou READ NEXT atingiu o final do arquivo (não há mais registros para ler)."
          },
          {
            "title": "OPTIONAL vazio",
            "desc": "Tentativa de READ em arquivo OPTIONAL que não existe ou está vazio."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Slot vazio",
            "desc": "O READ sequencial tentou acessar um slot de registro relativo que não contém dados."
          },
          {
            "title": "RRN além do limite",
            "desc": "O RELATIVE KEY especifica um número de registro que excede o range definido para o RRDS."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Chave fora de ordem",
            "desc": "Ao gravar um KSDS em modo sequencial (OPEN OUTPUT), a chave do registro atual é menor ou igual à do registro anterior."
          },
          {
            "title": "Dados não classificados",
            "desc": "O arquivo de entrada não foi SORT antes da carga sequencial no KSDS."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Tentou-se gravar um registro cuja chave primária já existe no KSDS."
          },
          {
            "title": "Reprocessamento",
            "desc": "O job está sendo re-executado e os registros já foram gravados na execução anterior."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O READ, START ou DELETE por chave não localizou nenhum registro correspondente."
          },
          {
            "title": "Chave incorreta",
            "desc": "A chave de pesquisa foi montada com dados incorretos (espaços, lixo de memória)."
          },
          {
            "title": "Arquivo vazio",
            "desc": "O arquivo VSAM existe mas não contém registros."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "KSDS cheio",
            "desc": "Não há mais espaço disponível (CI/CA splits esgotados) para inserir novos registros."
          },
          {
            "title": "RRDS overflow",
            "desc": "A Relative Record Number excede o número máximo de slots definidos no RRDS."
          },
          {
            "title": "Registro muito grande",
            "desc": "O tamanho do registro excede o RECORDSIZE máximo definido."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Falha de leitura/gravação no dispositivo de armazenamento (DASD ou fita)."
          },
          {
            "title": "Dataset corrompido",
            "desc": "A estrutura do VSAM foi danificada por abend anterior sem CLOSE adequado."
          },
          {
            "title": "Conflict de acesso",
            "desc": "Outro job ou CICS mantém lock exclusivo no dataset."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O dataset sequencial (QSAM) atingiu o limite de espaço alocado (extents esgotados)."
          },
          {
            "title": "Sem extensões",
            "desc": "Já foram alocados o máximo de 16 extents (ou limite do volume)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Dataset inexistente",
            "desc": "O dataset referenciado no DD não existe no catálogo."
          },
          {
            "title": "Nome incorreto",
            "desc": "O DSN no JCL está com erro de digitação ou qualificador errado."
          },
          {
            "title": "Volume errado",
            "desc": "O dataset existe mas em volume diferente do especificado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Modo conflitante",
            "desc": "Tentou-se OPEN I-O em arquivo sequencial de fita, ou OPEN EXTEND em KSDS."
          },
          {
            "title": "ESDS e I-O",
            "desc": "OPEN I-O não é válido para ESDS (Entry-Sequenced) sem acesso randômico."
          },
          {
            "title": "Fita e RANDOM",
            "desc": "Tentou-se acesso randômico em dispositivo de fita (tape)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Dataset em uso",
            "desc": "Outro job ou região CICS mantém o dataset com DISP=OLD (lock exclusivo)."
          },
          {
            "title": "Lock órfão",
            "desc": "Um abend anterior deixou o dataset em estado de lock sem CLOSE adequado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "RECFM incompatível",
            "desc": "O RECORD CONTAINS da FD não corresponde ao RECORDSIZE do VSAM ou RECFM do JCL."
          },
          {
            "title": "ORGANIZATION errada",
            "desc": "O programa define ORGANIZATION INDEXED mas o dataset é ESDS (sequencial)."
          },
          {
            "title": "Tamanho de chave",
            "desc": "O RECORD KEY no programa tem tamanho diferente do KEYS no DEFINE CLUSTER."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "OPEN duplicado",
            "desc": "O programa executou OPEN em um arquivo que já estava aberto (sem CLOSE intermediário)."
          },
          {
            "title": "Fluxo de controle",
            "desc": "Um PERFORM ou GO TO levou ao OPEN sem passar pelo CLOSE esperado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "CLOSE sem OPEN",
            "desc": "O programa executou CLOSE em um arquivo que nunca foi aberto ou já foi fechado."
          },
          {
            "title": "OPEN falhou",
            "desc": "O OPEN anterior falhou (ex: FS 35) mas o programa continuou até o CLOSE."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "REWRITE sem posição",
            "desc": "Em ACCESS MODE SEQUENTIAL, REWRITE exige que o último I/O bem-sucedido tenha sido um READ no mesmo arquivo."
          },
          {
            "title": "READ falhou",
            "desc": "O READ anterior retornou erro (ex: FS 23), invalidando a posição para REWRITE."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Em arquivo de registro fixo, o REWRITE tentou gravar um registro com tamanho diferente do lido pelo READ."
          },
          {
            "title": "MOVE truncado",
            "desc": "O MOVE para o registro alterou campos além do tamanho esperado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Leitura após EOF",
            "desc": "O programa continuou lendo após o FILE STATUS 10 (EOF) já ter sido retornado."
          },
          {
            "title": "Flag não verificada",
            "desc": "A condição de parada do PERFORM UNTIL não foi atualizada após o EOF."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Tentou-se READ em um arquivo que não foi aberto ou já foi fechado."
          },
          {
            "title": "Modo errado",
            "desc": "O arquivo foi aberto com OPEN OUTPUT (somente gravação)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Arquivo fechado",
            "desc": "Tentou-se WRITE em um arquivo que não foi aberto."
          },
          {
            "title": "Modo errado",
            "desc": "O arquivo foi aberto com OPEN INPUT (somente leitura)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Modo insuficiente",
            "desc": "DELETE e REWRITE exigem OPEN I-O, mas o arquivo está com OPEN INPUT ou OUTPUT."
          },
          {
            "title": "Arquivo fechado",
            "desc": "O arquivo já foi fechado quando a operação foi tentada."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Um erro de sistema não mapeado para nenhum FILE STATUS específico ocorreu."
          },
          {
            "title": "Problema ambiental",
            "desc": "Falha de infraestrutura, problema de catálogo ou erro de subsistema."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Catálogo danificado",
            "desc": "O catálogo VSAM (ICF) está com inconsistências internas."
          },
          {
            "title": "Segurança",
            "desc": "O RACF/ACF2/Top Secret está bloqueando o acesso com erro de validação."
          },
          {
            "title": "Password inválida",
            "desc": "Em sistemas legados com VSAM PASSWORD, a senha está incorreta."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "A região do job não tem memória suficiente para os buffers VSAM (BUFND/BUFNI)."
          },
          {
            "title": "Recurso bloqueado",
            "desc": "O dataset está alocado exclusivamente por outro job ou recurso do sistema indisponível."
          },
          {
            "title": "Limite de tarefas",
            "desc": "O sistema atingiu o limite de tarefas ou recursos de I/O."
          }
        ],
        "resolution": [
  ...
  "abendCodes": [
        ...
        "causes": [
          {
            ...
            "desc": "Falha física de leitura ou gravação no DASD ou fita."
          },
          {
            "title": "Block inválido",
            "desc": "O bloco lido está corrompido ou tem formato inesperado."
          },
          {
            "title": "BLKSIZE inconsistente",
            "desc": "O BLKSIZE no JCL não é múltiplo do LRECL para registros fixos (FB)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "DCB incompatível",
            "desc": "Os atributos DCB (RECFM, LRECL, BLKSIZE) do JCL conflitam com o dataset existente."
          },
          {
            "title": "DD ausente",
            "desc": "O programa referencia um DD que não existe no JCL."
          },
          {
            "title": "Concatenação inválida",
            "desc": "Datasets concatenados têm atributos de registro incompatíveis."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "DD faltando",
            "desc": "O programa COBOL executa OPEN em arquivo cujo ASSIGN TO não possui DD correspondente no JCL."
          },
          {
            "title": "Nome incorreto",
            "desc": "O nome no ASSIGN TO do SELECT não corresponde ao nome do DD no JCL."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Instrução inválida",
            "desc": "O processador tentou executar uma instrução com código de operação inválido."
          },
          {
            "title": "Branch para dados",
            "desc": "Um PERFORM ou CALL desviou para uma área de dados ao invés de código executável."
          },
          {
            "title": "Overlay de código",
            "desc": "O programa ou um CALL sobrescreveu área de instruções com dados."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Subscrito fora do range",
            "desc": "Acesso a uma tabela COBOL com índice além do OCCURS — ex: OCCURS 100, subscrito = 150."
          },
          {
            "title": "Ponteiro inválido",
            "desc": "SET ADDRESS OF aponta para memória não alocada ou liberada."
          },
          {
            "title": "CALL com parâmetros errados",
            "desc": "O programa chamado espera parâmetros diferentes dos passados pelo CALL USING."
          },
          {
            "title": "LINKAGE SECTION",
            "desc": "Referência a campo da LINKAGE SECTION sem SET ADDRESS ou sem parâmetro no CALL."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Uma instrução referenciou endereço de memória que não existe (acima de MEMLIMIT)."
          },
          {
            "title": "Ponteiro nulo",
            "desc": "SET ADDRESS OF com ponteiro zerado ou não inicializado."
          },
          {
            "title": "GETMAIN falhou",
            "desc": "A alocação dinâmica de memória falhou mas o ponteiro foi usado mesmo assim."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Alinhamento incorreto",
            "desc": "Campo COMP (binário) ou COMP-1/COMP-2 (ponto flutuante) não está em boundary alinhado."
          },
          {
            "title": "Instrução inválida",
            "desc": "Operando de instrução em endereço ímpar quando deveria ser par."
          },
          {
            "title": "OCCURS com subscrito",
            "desc": "Subscrito de tabela contém valor que gera endereço desalinhado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Campo não inicializado",
            "desc": "Campo PIC 9 ou COMP-3 contém espaços ou lixo — não foi inicializado."
          },
          {
            "title": "Dados inválidos",
            "desc": "Registro lido de arquivo ou DB2 contém dados não numéricos em campo numérico."
          },
          {
            "title": "REDEFINES conflitante",
            "desc": "REDEFINES de campo alfanumérico usado como numérico sem validação."
          },
          {
            "title": "MOVE incorreto",
            "desc": "MOVE de campo alfanumérico para numérico sem verificação prévia."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Divisor zero",
            "desc": "Uma instrução DIVIDE ou COMPUTE com divisão tem o divisor igual a zero."
          },
          {
            "title": "Campo não inicializado",
            "desc": "O campo divisor não foi populado antes da operação de divisão."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "DSN inexistente",
            "desc": "O dataset especificado no JCL não existe no catálogo do sistema."
          },
          {
            "title": "Nome incorreto",
            "desc": "Erro de digitação no DSN, HLQ (High Level Qualifier) ou qualificador."
          },
          {
            "title": "Catálogo errado",
            "desc": "O dataset está catalogado em catálogo diferente do esperado."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O operador emitiu CANCEL jobname ou P jobname para encerrar o job."
          },
          {
            "title": "Política de operação",
            "desc": "O job excedeu tempo de espera definido na política da instalação."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Loop infinito",
            "desc": "O programa entrou em loop infinito consumindo todo o tempo de CPU alocado."
          },
          {
            "title": "TIME insuficiente",
            "desc": "O TIME no JCL é muito baixo para o volume de processamento."
          },
          {
            "title": "Volume inesperado",
            "desc": "O volume de dados de entrada é muito maior que o esperado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Tabelas grandes",
            "desc": "O programa aloca tabelas OCCURS com muitos elementos consumindo toda a REGION."
          },
          {
            "title": "REGION insuficiente",
            "desc": "O parâmetro REGION no JCL está abaixo do necessário para buffers de I/O e WORKING-STORAGE."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Deadlock de recursos",
            "desc": "O job está esperando um recurso que nunca será liberado (deadlock)."
          },
          {
            "title": "Dataset em uso",
            "desc": "O dataset está alocado com DISP=OLD por outro job de longa duração."
          },
          {
            "title": "Wait em WTOR",
            "desc": "O job está esperando uma resposta do operador que não foi dada."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Linkedit incompleto",
            "desc": "O módulo não passou por linkedit corretamente — está como object module."
          },
          {
            "title": "Módulo corrompido",
            "desc": "O load module na biblioteca está danificado ou truncado."
          },
          {
            "title": "Formato incompatível",
            "desc": "O módulo é AMODE/RMODE incompatível com o ambiente de execução."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Load module ausente",
            "desc": "O programa chamado via CALL ou o módulo executável (PGM=) não existe nas bibliotecas."
          },
          {
            "title": "Nome incorreto",
            "desc": "O nome no CALL ou PGM está com erro de digitação."
          },
          {
            "title": "Biblioteca errada",
            "desc": "O load module está em biblioteca que não está na concatenação STEPLIB/JOBLIB."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "REGION pequena",
            "desc": "O valor de REGION no JCL é insuficiente para a WORKING-STORAGE e buffers."
          },
          {
            "title": "GETMAIN excessivo",
            "desc": "O programa faz muitas alocações dinâmicas de memória sem FREEMAIN."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Alocação excessiva",
            "desc": "O programa ou subsistema tentou alocar mais memória acima da barra do que o permitido."
          },
          {
            "title": "MEMLIMIT",
            "desc": "O MEMLIMIT do JCL ou default do sistema restringe a memória 64-bit disponível."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sem permissão",
            "desc": "O userid do job não tem autorização RACF para acessar o dataset no nível requerido."
          },
          {
            "title": "Nível insuficiente",
            "desc": "Tem READ mas precisa de UPDATE; tem UPDATE mas precisa de ALTER."
          },
          {
            "title": "Grupo protegido",
            "desc": "O dataset pertence a grupo RACF que não inclui o userid."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Extents esgotados",
            "desc": "O dataset atingiu o limite de extensões secundárias (máximo 16 por volume)."
          },
          {
            "title": "Volume cheio",
            "desc": "Não há mais espaço livre no volume DASD para extensão."
          },
          {
            "title": "Secondary insuficiente",
            "desc": "O secondary allocation é muito pequeno para o volume de dados."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Volumes cheios",
            "desc": "Nenhum volume elegível no storage group tem espaço suficiente para extensão."
          },
          {
            "title": "Secondary = 0",
            "desc": "O dataset foi definido sem secondary allocation (secondary = 0)."
          },
          {
            "title": "Sem multi-volume",
            "desc": "O dataset não permite extensão para volumes adicionais."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "SORTWK ausente",
            "desc": "Os DD statements SORTWK01, SORTWK02, etc. não estão definidos no JCL."
          },
          {
            "title": "Memória insuficiente",
            "desc": "Não há memória suficiente para o workspace do SORT interno."
          },
          {
            "title": "SORT error",
            "desc": "Erro nos parâmetros de SORT (campos, sequência, tamanho de registro)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "EXEC CICS ABEND",
            "desc": "O programa emitiu EXEC CICS ABEND ABCODE('1026') propositalmente ou via handler."
          },
          {
            "title": "Exceção não tratada",
            "desc": "Uma condição CICS não foi tratada pelo programa (HANDLE/RESP)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "PLAN não encontrado",
            "desc": "O PLAN ou PACKAGE DB2 não foi encontrado ou não está bound."
          },
          {
            "title": "Conexão perdida",
            "desc": "A conexão com o subsistema DB2 foi interrompida durante a execução."
          },
          {
            "title": "BIND desatualizado",
            "desc": "O programa foi recompilado mas o BIND PLAN/PACKAGE não foi refeito."
          }
        ],
        "resolution": [
  ...
  "sqlcodes": [
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "DB2 indisponível",
            "desc": "O subsistema DB2 não está ativo ou perdeu a conexão durante a execução."
          },
          {
            "title": "Attachment facility",
            "desc": "O call attachment facility (CAF) ou RRSAF não está corretamente inicializado."
          },
          {
            "title": "IMS/CICS disconnect",
            "desc": "A conexão entre IMS/CICS e o DB2 foi perdida."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sem GRANT",
            "desc": "O userid/plan não tem o privilégio necessário (SELECT, INSERT, UPDATE, DELETE, EXECUTE)."
          },
          {
            "title": "BIND authority",
            "desc": "O userid não tem autoridade para fazer BIND do package/plan."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Deadlock puro",
            "desc": "Ao contrário do -911 (que pode ser timeout), -913 é especificamente deadlock detectado pelo DB2."
          },
          {
            "title": "Recursos cruzados",
            "desc": "Duas transações bloqueiam recursos na ordem inversa: A→B vs B→A."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Deadlock",
            "desc": "Duas ou mais transações bloquearam-se mutuamente em recursos diferentes."
          },
          {
            "title": "Lock timeout",
            "desc": "A transação esperou mais tempo que o LOCKTIME permite para obter lock."
          },
          {
            "title": "Contenção alta",
            "desc": "Muitas transações acessando as mesmas páginas simultaneamente."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "STOP pendente",
            "desc": "O tablespace ou index está em status STOP (parado pelo DBA)."
          },
          {
            "title": "Utility em execução",
            "desc": "Um utilitário DB2 (REORG, LOAD, RECOVER) está executando no objeto."
          },
          {
            "title": "CHECK pending",
            "desc": "O tablespace está em estado de CHECK PENDING após LOAD com erro de RI."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "DBRM desatualizado",
            "desc": "O DBRM usado no BIND é de uma pré-compilação anterior ao programa atual."
          },
          {
            "title": "BIND parcial",
            "desc": "O programa foi pré-compilado novamente mas o BIND não foi refeito."
          },
          {
            "title": "Biblioteca errada",
            "desc": "O BIND usou DBRM de biblioteca incorreta (ex: teste ao invés de produção)."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O SELECT INTO (singleton select) retornou mais de um registro."
          },
          {
            "title": "WHERE insuficiente",
            "desc": "A cláusula WHERE não é restritiva o bastante para garantir unicidade."
          },
          {
            "title": "Dados duplicados",
            "desc": "A tabela contém registros duplicados que deveriam ser únicos."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "BIND não executado",
            "desc": "O programa foi compilado mas o BIND PLAN/PACKAGE não foi executado."
          },
          {
            "title": "Nome incorreto",
            "desc": "O nome do plan/package no BIND não corresponde ao esperado pelo programa."
          },
          {
            "title": "DBRM ausente",
            "desc": "O DBRM gerado na pré-compilação não está na biblioteca especificada no BIND."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Chave duplicada",
            "desc": "O INSERT ou UPDATE resultaria em valor duplicado em coluna (ou combinação) com constraint UNIQUE."
          },
          {
            "title": "Reprocessamento",
            "desc": "O registro já foi inserido em execução anterior e o job está sendo re-executado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sem privilégio DML",
            "desc": "O userid não tem SELECT, INSERT, UPDATE ou DELETE na tabela específica."
          },
          {
            "title": "Schema diferente",
            "desc": "A tabela pertence a outro schema e o userid não tem GRANT nesse schema."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Parent inexistente",
            "desc": "O INSERT ou UPDATE referencia um valor de foreign key que não existe na tabela pai."
          },
          {
            "title": "Ordem errada",
            "desc": "O registro filho está sendo inserido antes do registro pai."
          },
          {
            "title": "FK incorreta",
            "desc": "O valor da foreign key está errado ou com formato incorreto."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "OPEN ausente",
            "desc": "O FETCH foi executado antes do OPEN CURSOR."
          },
          {
            "title": "CLOSE prematuro",
            "desc": "O cursor foi fechado (CLOSE) mas o FETCH continuou tentando ler."
          },
          {
            "title": "Commit fechou cursor",
            "desc": "Um COMMIT fechou o cursor que não foi declarado WITH HOLD."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "NULL sem indicador",
            "desc": "A coluna contém NULL mas a variável host não tem indicador associado para receber o NULL."
          },
          {
            "title": "DCLGEN sem indicator",
            "desc": "A DCLGEN não gerou variáveis indicadoras ou elas não foram incluídas no SQL."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "A variável host COBOL não é compatível com o tipo da coluna DB2."
          },
          {
            "title": "Truncamento",
            "desc": "O valor da coluna é maior que a variável host definida no programa."
          },
          {
            "title": "DCLGEN desatualizada",
            "desc": "A definição da coluna mudou mas a DCLGEN no programa não foi atualizada."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Nome incorreto",
            "desc": "A coluna referenciada no SQL não existe na tabela."
          },
          {
            "title": "Erro de digitação",
            "desc": "Typo no nome da coluna — ex: NOME_CLENTE ao invés de NOME_CLIENTE."
          },
          {
            "title": "DDL pendente",
            "desc": "A coluna foi adicionada por ALTER TABLE mas o BIND não foi refeito."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "A tabela, view ou alias referenciado no SQL não existe no schema especificado."
          },
          {
            "title": "Schema incorreto",
            "desc": "O qualificador de schema (owner) está errado — ex: SCHEMA1.TABELA vs SCHEMA2.TABELA."
          },
          {
            "title": "Não autorizado",
            "desc": "A tabela existe mas o userid não tem SELECT no catálogo para vê-la."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Mês inválido",
            "desc": "O mês está fora do range 01-12."
          },
          {
            "title": "Dia inválido",
            "desc": "O dia está fora do range válido para o mês/ano (ex: 31 para mês de 30 dias)."
          },
          {
            "title": "Hora inválida",
            "desc": "Hora, minuto ou segundo fora do range (hora: 00-24, minuto/segundo: 00-59)."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O valor passado para coluna DATE, TIME ou TIMESTAMP não está no formato esperado pelo DB2."
          },
          {
            "title": "Data inexistente",
            "desc": "A data informada não existe — ex: 2025-02-30 (fevereiro não tem dia 30)."
          },
          {
            "title": "Host variable",
            "desc": "A variável host COBOL está com formato incorreto para o tipo datetime."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sintaxe incorreta",
            "desc": "O pré-compilador DB2 encontrou um token inesperado no comando SQL."
          },
          {
            "title": "Palavra reservada",
            "desc": "Um nome de coluna ou variável é palavra reservada do DB2 sem delimitador."
          },
          {
            "title": "Vírgula faltando",
            "desc": "Falta vírgula, parêntese ou outro delimitador na sintaxe SQL."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Execução normal",
            "desc": "O comando SQL foi executado sem erros ou condições especiais."
          }
        ],
        "resolution": [
          "Prossiga com o fluxo normal do programa."
    ...
    {
      "code": "+100",
      "meaning": "Registro não encontrado ou fim do cursor (SQLCODE +100; em alguns relatórios aparece como 100 sem sinal)",
      "action": "Tratar condição de 'not found' ou encerrar loop de FETCH",
      "severity": "info",
      "diagnostic": {
        "causes": [
          {
            "title": "SELECT sem resultado",
            "desc": "A query SELECT INTO não encontrou nenhuma linha correspondente."
          },
          {
            "title": "Fim do cursor",
            "desc": "O FETCH atingiu o fim do result set — não há mais linhas."
          },
          {
            "title": "UPDATE/DELETE vazio",
            "desc": "O UPDATE ou DELETE WHERE não encontrou linhas para atualizar/excluir."
          }
        ],
        "resolution": [
        ...
        "tip": "+100 em FETCH é condição normal de fim. Em SELECT INTO pode indicar dados faltantes — trate adequadamente. SQLCODE 100 sem '+' é o mesmo estado que +100 — use IF SQLCODE = +100 ou = 100 conforme o compilador."
      }
    }
  ],
  "eibresp": [
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sem sessão disponível",
            "desc": "Não há sessão livre para comunicação com o sistema remoto."
          },
          {
            "title": "Conexão inativa",
            "desc": "A conexão com o sistema remoto não está ACQUIRED."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O arquivo, transação ou programa foi explicitamente desabilitado pelo administrador CICS."
          },
          {
            "title": "Auto-disable",
            "desc": "O CICS desabilitou o recurso automaticamente após erros repetidos."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "AIX com duplicatas",
            "desc": "O arquivo tem Alternate Index definido com NONUNIQUEKEY e registros duplicados para a chave alternada."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Chave duplicada",
            "desc": "O EXEC CICS WRITE tentou inserir registro com chave primária que já existe no KSDS."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Fila TD vazia",
            "desc": "Todos os registros da fila Transient Data foram lidos (fila vazia)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Fim do browse",
            "desc": "O READNEXT ou READPREV atingiu o fim (ou início) do arquivo durante BROWSE."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Erro genérico",
            "desc": "Uma condição de erro ocorreu que não se enquadra em nenhuma resposta específica."
          },
          {
            "title": "Programa chamado",
            "desc": "O programa chamado via LINK retornou com erro não tratado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Timer expirado",
            "desc": "O intervalo especificado em DELAY, POST ou RETRIEVE com WAIT expirou normalmente."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "FCT ausente",
            "desc": "O nome do arquivo usado no EXEC CICS READ/WRITE não tem entry na File Control Table."
          },
          {
            "title": "Nome incorreto",
            "desc": "O nome do arquivo no programa não corresponde ao definido na FCT/CSD."
          },
          {
            "title": "CSD não atualizado",
            "desc": "O arquivo foi definido mas o CICS não foi atualizado (NEWCOPY/INSTALL)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Erro VSAM",
            "desc": "O VSAM retornou um erro que o CICS mapeia como ILLOGIC."
          },
          {
            "title": "Estado inconsistente",
            "desc": "O arquivo VSAM está em estado lógico inconsistente."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Mapa grande demais",
            "desc": "O mapa BMS define mais linhas ou colunas do que o terminal suporta."
          },
          {
            "title": "Terminal incompatível",
            "desc": "O terminal é modelo 2 (24×80) mas o mapa foi desenhado para modelo 4 (43×80) ou 5 (27×132)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Partition inexistente",
            "desc": "O nome de partition especificado no comando BMS não existe na definição do partitionset."
          },
          {
            "title": "Terminal sem suporte",
            "desc": "O terminal não suporta partitioned screens."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "Um parâmetro do comando EXEC CICS tem valor inválido ou combinação incompatível."
          },
          {
            "title": "Estado incorreto",
            "desc": "O comando foi emitido em momento inadequado (ex: REWRITE sem READ prévio)."
          },
          {
            "title": "Tipo de arquivo",
            "desc": "A operação não é suportada pelo tipo de arquivo (ex: DELETE em ESDS)."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "A combinação de parâmetros no READQ/WRITEQ/DELETEQ TS é inválida."
          },
          {
            "title": "Fila inexistente",
            "desc": "Tentou-se operação em fila TS que não existe (para algumas operações)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Erro de I/O",
            "desc": "Falha irrecuperável de leitura/gravação no dataset VSAM subjacente."
          },
          {
            "title": "VSAM corrompido",
            "desc": "O dataset VSAM está com erro de estrutura (índice ou dados danificados)."
          }
        ],
        "resolution": [
        ...
        "causes": [
          {
            ...
            "desc": "O ITEM number especificado no READQ TS é maior que o número de itens na fila."
          },
          {
            "title": "Item zero",
            "desc": "Foi especificado ITEM(0) — itens são numerados a partir de 1."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "LENGTH incorreto",
            "desc": "O LENGTH especificado no EXEC CICS READ/WRITE não corresponde ao tamanho real do registro."
          },
          {
            "title": "Buffer pequeno",
            "desc": "A área de dados (COMMAREA ou buffer) é menor que o registro retornado."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "RECEIVE MAP sem dados",
            "desc": "O EXEC CICS RECEIVE MAP não encontrou dados no buffer de entrada do terminal."
          },
          {
            "title": "CLEAR key",
            "desc": "O usuário pressionou CLEAR, que limpa a tela sem enviar dados."
          },
          {
            "title": "PA key",
            "desc": "As teclas PA1/PA2/PA3 geram AID mas não enviam dados do mapa."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Execução normal",
            "desc": "O comando EXEC CICS foi executado sem erros."
          }
        ],
        "resolution": [
          "Prossiga com o fluxo normal da transação."
        ],
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "VSAM cheio",
            "desc": "O dataset VSAM não tem mais espaço para CI/CA splits."
          },
          {
            "title": "Extents esgotados",
            "desc": "O número máximo de extents foi atingido."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sem permissão CICS",
            "desc": "O userid da transação não tem autorização de segurança (ESM/RACF) para o recurso."
          },
          {
            "title": "Resource security",
            "desc": "A segurança de recursos CICS (RESSEC) está ativa e o userid não tem acesso."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Chave inexistente",
            "desc": "O READ com chave especificada não localizou registro correspondente no VSAM."
          },
          {
            "title": "Arquivo vazio",
            "desc": "O arquivo VSAM não contém registros."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Arquivo fechado",
            "desc": "O arquivo está definido no CICS mas está em status CLOSED."
          },
          {
            "title": "DISABLED",
            "desc": "O arquivo está DISABLED na FCT — não aceita operações."
          },
          {
            "title": "Erro anterior",
            "desc": "Um erro anterior causou o fechamento automático do arquivo."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Partitionset corrompido",
            "desc": "A definição do partitionset está inválida ou corrompida."
          },
          {
            "title": "Incompatibilidade",
            "desc": "O partitionset não é compatível com o modelo de terminal em uso."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Programa não definido",
            "desc": "O programa referenciado em LINK/XCTL não está definido na PPT (Processing Program Table) ou CSD."
          },
          {
            "title": "Load module ausente",
            "desc": "A definição existe mas o load module não está na DFHRPL (concatenação de bibliotecas)."
          },
          {
            "title": "NEWCOPY necessário",
            "desc": "O módulo foi reinstalado mas CICS ainda usa a versão antiga em memória."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Contenção",
            "desc": "Outra transação está acessando a mesma fila TS ou TD com lock exclusivo."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "TS vazia",
            "desc": "A fila TS que o programa tenta ler não contém itens (está vazia ou nunca foi criada)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Paginação",
            "desc": "O terminal retornou condição de paging em operação de BMS multi-página."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Sistema remoto indisponível",
            "desc": "O sistema CICS remoto definido no ROUTE não está acessível."
          },
          {
            "title": "MRO/ISC",
            "desc": "A conexão Multi-Region Operation ou Inter-System Communication falhou."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Tecla especial",
            "desc": "O usuário ativou uma função de sinal (ex: ATTN key em terminal 3270)."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Condição ignorada",
            "desc": "O programa tem IGNORE CONDITION para esta exceção — a condição ocorreu mas foi suprimida."
          },
          {
            "title": "NOHANDLE",
            "desc": "O comando foi emitido com NOHANDLE — todas as condições são suprimidas."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "MAXTASK atingido",
            "desc": "O número máximo de tasks simultâneas no CICS foi atingido."
          },
          {
            "title": "Pico de carga",
            "desc": "Muitas transações sendo executadas simultaneamente."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "SYSID não definido",
            "desc": "O SYSID referenciado no comando (ex: LINK SYSID('xxxx')) não está definido na CONNECTION."
          },
          {
            "title": "Sistema offline",
            "desc": "O sistema remoto está definido mas a conexão não está ativa."
          }
        ],
        "resolution": [
    ...
    },
    {
      ...
      "diagnostic": {
        "causes": [
          {
            "title": "Transação não definida",
            "desc": "O transaction ID usado em START, RETURN TRANSID ou digitado no terminal não está na PCT/CSD."
          },
          {
            "title": "ID incorreto",
            "desc": "O transaction ID tem erro de digitação (IDs são de 1-4 caracteres)."
          }
        ],
        "resolution": [
  ...
  "jclTips": [
    {
      ...
      "content": "<dl><dt>DSN=</dt><dd>Nome do dataset (até 44 caracteres). Use <code>&amp;&amp;TEMP</code> para temporários e <code>*.stepname.ddname</code> para referência retroativa.</dd><dt>DISP=(status,normal,abend)</dt><dd><strong>status:</strong> NEW (criar), OLD (exclusivo), SHR (compartilhado), MOD (append). <strong>normal/abend:</strong> KEEP, DELETE, CATLG, UNCATLG, PASS.</dd><dt>SPACE=(unit,(prim,sec,dir))</dt><dd><strong>unit:</strong> TRK (trilhas), CYL (cilindros), bytes. <strong>prim:</strong> alocação primária. <strong>sec:</strong> secundária (até 15 extensões). <strong>dir:</strong> blocos de diretório para PDS.</dd><dt>DCB=(RECFM=,LRECL=,BLKSIZE=)</dt><dd><strong>RECFM:</strong> FB (fixo blocado), VB (variável blocado), FBA (fixo com ASA). <strong>LRECL:</strong> tamanho do registro lógico. <strong>BLKSIZE:</strong> tamanho do bloco (0 = sistema define).</dd><dt>UNIT= / VOL=SER=</dt><dd>Dispositivo (SYSDA para disco, TAPE para fita) e volume serial específico. Em ambientes SMS, geralmente gerenciado automaticamente.</dd><dt>SYSOUT=</dt><dd>Classe de saída para spool (impressão). <code>SYSOUT=*</code> usa a classe do MSGCLASS do JOB. <code>SYSOUT=A</code> especifica classe A.</dd></dl>"
    },
    {
      "id": "tip-rc",
      "title": "Return Codes e Tratamento de Erros",
      "content": "<dl><dt>RC = 0</dt><dd>Execução bem-sucedida. Todas as operações completaram sem erros ou avisos.</dd><dt>RC = 4</dt><dd>Aviso (warning). O step executou com sucesso mas há alertas que devem ser revisados — ex: compilação com warnings.</dd><dt>RC = 8</dt><dd>Erro recuperável. Resultados podem estar incompletos ou com problemas. Investigar sysprint/sysout.</dd><dt>RC = 12</dt><dd>Erro severo. O step completou mas com falhas significativas. Resultados não são confiáveis.</dd><dt>RC = 16</dt><dd>Erro terminal. O step não conseguiu completar a operação principal. Requer correção imediata.</dd><dt>RC > 16</dt><dd>Erro crítico. Condição excepcional — geralmente indica abend controlado ou falha de sistema.</dd><dt>MAXCC</dt><dd>No JES2, MAXCC mostra o maior return code entre todos os steps. Verifique cada step individual para localizar o erro.</dd></dl>"
    },
    {
      "id": "tip-util",
      "title": "Utilitários z/OS Essenciais",
      "content": "<dl><dt>IEBGENER</dt><dd>Cópia simples de datasets sequenciais. <code>SYSUT1</code> = entrada, <code>SYSUT2</code> = saída. Para cópia direta sem alteração, use <code>SYSIN DD DUMMY</code>.</dd><dt>IEBCOPY</dt><dd>Cópia, compressão e merge de PDSs (Partitioned Data Sets). Essencial para deploy de load modules e copybooks entre bibliotecas.</dd><dt>IEFBR14</dt><dd>Programa 'no-op' — não faz nada, mas executa o JCL. Usado para criar/deletar datasets via DISP=(NEW,CATLG) ou DISP=(OLD,DELETE).</dd><dt>IDCAMS</dt><dd>Utilitário multi-função para VSAM: DEFINE CLUSTER, DELETE, REPRO, PRINT, VERIFY, LISTCAT, ALTER. Indispensável para administração VSAM.</dd><dt>DFSORT / SYNCSORT</dt><dd>Classificação (SORT), merge e cópia de datasets. Suporta INCLUDE/OMIT (filtro), INREC/OUTREC (reformatação) e OUTFIL (múltiplas saídas).</dd><dt>IKJEFT01</dt><dd>Executor de comandos TSO em batch. Usado para executar REXX, CLIST, DSN (DB2) e outros comandos TSO dentro de um JCL.</dd></dl>"
    },
    {
      "id": "tip-cond",
      "title": "COND vs IF/THEN/ELSE — Execução Condicional",
      "content": "<dl><dt>COND (legado)</dt><dd><code>COND=(4,LT)</code> significa: NÃO execute este step se 4 é MENOR QUE o return code de algum step anterior. Leitura invertida: o step é PULADO se a condição é verdadeira. <strong>Dica:</strong> <code>COND=(0,NE)</code> = execute somente se todos os steps anteriores retornaram 0.</dd><dt>COND com step</dt><dd><code>COND=(8,LE,STEP01)</code> = pule se 8 ≤ RC do STEP01. Permite testar return code de step específico.</dd><dt>COND=EVEN</dt><dd>Execute este step MESMO se um step anterior abendou. Útil para steps de cleanup e finalização.</dd><dt>COND=ONLY</dt><dd>Execute este step SOMENTE se um step anterior abendou. Ideal para tratamento de erro e notificação.</dd><dt>IF/THEN/ELSE (moderno)</dt><dd><code>// IF STEP01.RC &lt;= 4 THEN</code> — sintaxe direta e legível. Suporta AND, OR, NOT. <strong>Sempre prefira IF/THEN/ELSE sobre COND</strong> por clareza.</dd><dt>IF com ABEND</dt><dd><code>// IF STEP01.ABEND THEN</code> — testa se step específico abendou. Também aceita <code>ABENDCC</code> para testar o código do abend.</dd></dl>"
    }
  ]
};
